defmodule EthereumJSONRPC.Receipt do
  ...
  defp entry_to_elixir({key, _} = entry)
       when key in ~w(blockHash contractAddress from gas logsBloom root to transactionHash revertReason type effectiveGasPrice l1GasPrice l1GasUsed l1Fee l1FeeScalar),
       do: {:ok, entry}
